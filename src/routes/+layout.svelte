...
<div class="min-h-screen bg-stone-200 flex">
	...
	<div class="flex-1 min-w-0">
		...
		<div class="sticky top-0 z-20 bg-stone-200 border-b border-stone-300 px-4 md:px-6 py-2 flex items-center justify-between gap-3">
			<button
			...
			>
				...
				<span class="hidden sm:inline">{sidebarOpen ? 'Hide' : 'Editions'}</span>
			</button>
